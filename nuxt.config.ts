  ...
  sitemap: {
    ...
    urls: async () => {
      const staticUrls = [
        ...
        { loc: '/destination-tours/cotswolds', priority: 0.85, changefreq: 'monthly' },
        { loc: '/destination-tours/stonehenge', priority: 0.85, changefreq: 'monthly' },
        { loc: '/destination-tours/windsor', priority: 0.85, changefreq: 'monthly' },
      ]
